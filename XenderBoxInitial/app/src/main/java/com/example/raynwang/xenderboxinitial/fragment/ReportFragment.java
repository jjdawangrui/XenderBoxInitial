...
public class ReportFragment extends android.support.v4.app.Fragment {
    ...
    public static void initSubTitle() {
        tabLayout.getTabAt(0).setText("Installation");
        tabLayout.getTabAt(1).setText("Income");
        tabLayout.getTabAt(2).setText("Day Report");
    }

    //初始化子fragment
    public static void initSubFragment() {
        subFragments.clear();
        subFragments.add(new ReportInstallationFragment());
        subFragments.add(new ReportIncomeFragment());
        subFragments.add(new ReportDayReportFragment());
